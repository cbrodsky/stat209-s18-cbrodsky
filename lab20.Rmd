...
**Answer**: The slope represents the change in the price of diamonds.
...
**Answer**: yes because 5500 would fall significantly outside the confidence interval listed for the slope.

Would you be surprised if we collected another set of diamonds, in exactly the
same way as before, and found a slope estimate equal to 7500?

**Answer**: Not as suprised as 5500, because 7500 is much closer than 5500 to the slope confidence interval. 
...
**Answer**: Both for the intercept and slope, the confidence intervals are significant as both are negative for the intercept and positive for the slope. This is important because the data shows there is most likely a positive relationship between a diamond's price and carats. 
...
**Answer**: For the intercept, the confidence interval only contains estimates that are positive, whereas for the slope, the confidence interval only contains negative values. 

Interpret this in words (your words, not just the formal definition).

**Answer**: Because the confidence intervals are significant (both being positive/negative for intercept and slope), we can determine that a positive relationship exists between the two variables of price and weight. 
...
**Answer**: Yes, both are significant becasuse the confidence intervals are both negative and positive for depth and carat. 
